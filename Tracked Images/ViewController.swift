    ...
    public func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        if let imageAnchor = anchor as? ARImageAnchor {
            ...
            if imageAnchor.referenceImage.name == "prague image" {
                ...
                plane.materials[0].diffuse.contents = UIImage(named: "test2")
            }
                
            else if imageAnchor.referenceImage.name == "a1" {
                plane.materials = [SCNMaterial()]
                plane.materials[0].diffuse.contents = UIImage(named: "art.scnassets/a2.jpg")
            }
            
            else if imageAnchor.referenceImage.name == "c2" {
                plane.materials = [SCNMaterial()]
                plane.materials[0].diffuse.contents = UIImage(named: "art.scnassets/c1.jpg")
            }
            
            else if imageAnchor.referenceImage.name == "d2" {
                plane.materials = [SCNMaterial()]
                plane.materials[0].diffuse.contents = UIImage(named: "art.scnassets/d1.jpg")
            }
            
            else if imageAnchor.referenceImage.name == "chocolate" {
                plane.materials = [SCNMaterial()]
                plane.materials[0].diffuse.contents = UIImage(named: "art.scnassets/b1chocolate.jpg")
            }
